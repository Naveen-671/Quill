              ...
              async ({ plan, tagline, quota, features }) => {
                ...
                return (
                  <div
                    ...
                    {plan === 'Pro' && (
                      <div className='absolute -top-5 left-0 right-0 mx-auto w-32 rounded-full bg-gradient-to-r from-cyan-600 to-purple-600 px-3 py-2 text-sm font-medium text-white'>
                        Upgrade now
                      </div>
                    )}
